...
namespace backend.Migrations
{
    ...
    [Migration("20260210120344_PortfolioManyToMany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "cbe7b9c0-29f9-4529-806c-625baf72c29b",
                            Name = "Admin",
                            NormalizedName = "Admin"
                        },
                        new
                        {
                            Id = "8ccbd23f-df1c-4f21-82bd-7d57f6dd69d4",
                            Name = "User",
                            NormalizedName = "User"
                        });
                });
            ...
            modelBuilder.Entity("backend.Models.Portfolio", b =>
                {
                    b.HasOne("backend.Models.Users", "AppUser")
                        .WithMany("Portfolios")
